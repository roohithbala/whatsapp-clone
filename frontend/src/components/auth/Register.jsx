...
export default function Register({ onSuccess, onNavigate }) {
  ...
  return (
    <div className="auth-card animate-modal-appear">
      ...
      <h2 className="text-3xl font-extrabold text-[var(--text-primary)] tracking-tight mb-2">Create Account</h2>
      <p className="text-sm text-[var(--text-secondary)] mb-8 font-medium">Join us to start real-time messaging</p>
