...
export default function AuthHeader({ title, subtitle }) {
  return (
    <>
      ...
      <h2 className="text-3xl font-extrabold text-[var(--text-primary)] tracking-tight mb-2">{title}</h2>
      <p className="text-sm text-[var(--text-secondary)] mb-8 font-medium">{subtitle}</p>
    </>
  );
}
